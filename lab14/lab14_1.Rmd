...
ui <- fluidPage(
    ...
    plotOutput("plot", width="500px", height="400px") #adjusting the size of the visual 
)
...
ui <- fluidPage(
    ...
    plotOutput("plot") #adjusting the size of the visual 
)
...
server <- function(input, output,session) {
  ...
  ggplot(data=homerange, aes_string (x="locomation", y=input$x))+
           geom_bar(position="dodge")+
           labs(x=NULL. fill="Fill Variables")
```
