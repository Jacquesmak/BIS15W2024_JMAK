...
relig_income %>% 
  pivot_longer(-religion, #patient will not move
               ...
               values_to="total" #values moved to a new column called "heartrate"
               )
```
...
billboard3 <- 
  billboard %>% 
  pivot_longer(-c(artist, track, date.entered), #specific columns to stay fixed don't move
               names_to = "week",
               values_to = "rank",
               values_drop_na = TRUE
               )
