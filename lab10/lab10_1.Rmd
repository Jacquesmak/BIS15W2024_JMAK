...
```{r}
ggplot(data=iris, #specify the data
       mapping=aes(y=Sepal.Length, x=Sepal.Width))+ #map the aesthetics
...
ggplot(data=homerange, mapping=aes(x=log10.mass, y=log10.hra))+
  geom_jitter()# add some random noise
```
...
```{r}
ggplot(data=homerange, mapping=aes(x=log10.hra, y=log10.praymass))+geom_point()+geom_smooth 
